	...
	----------------------------------------------------------------------
	-- Leatrix Sounds 1.13.88.alpha.55 (8th December 2020)
	----------------------------------------------------------------------
	...
	-- Version
	LeaSoundsLC["AddonVer"] = "1.13.88.alpha.55"
	...
	do
		...
		local subTitle = LeaSoundsLC:MakeTx(interPanel, "curseforge.com/wow/addons/leatrix-sounds-classic", 0, 0)
